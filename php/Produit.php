...
<div class="wrapper">
    ...
    <form action="/Projet_Web/index.php?action=AddProduit" method="POST">
        ...
        <div class="form-group">
            ...
            <input name="prix" id="prix" placeholder="en euros" required />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="classe" id="classe" placeholder="Dure / Douce / Légale"></input>
